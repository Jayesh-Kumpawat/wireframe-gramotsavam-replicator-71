        ...
        <div className="w-80 space-y-4">
          ...
          <div className="space-y-3">
            {filteredMatches.map(match => (
              <Card key={match.id} className="p-4 cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => navigate(`/match-details/${match.id}`)}>
          ...
          <div className="border-t bg-muted/30 mt-8">
            <div className="flex">
              ...
              <div className="flex-1 flex flex-col items-center py-4 cursor-pointer" onClick={() => navigate("/poc-profile")}>
